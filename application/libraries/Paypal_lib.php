...
class Paypal_lib{
    ...
    function paypal_auto_form(){
        ...
        echo '<p style="text-align:center;">Please wait, your transaction is being processed and you will be redirected to the paypal website.</p>' . "\n";
